...
def main():
    ...
    # usage: python exp1_chatbotarena_typhoon2_text_text.py --data_path chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/text-text-typhoon2.jsonl --order ab

    # usage: python exp1_chatbotarena_typhoon2_text_text.py --data_path chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/text-text-typhoon2_BA.jsonl --order ba
