...
def analyze_comparison(text):
    ...
    - D: 'Error or inconclusive (i.e., you cannot determine from the text)'

    Note that A might also be reffered to as Audio A, the first option or the left option. B might also be reffered to as Audio B, second option, or the right option.

    Text: "{text}"

    You must strictly output only one letter, i.e., A, B, C, D following the guideline above. Do not include any additional information.
    """
