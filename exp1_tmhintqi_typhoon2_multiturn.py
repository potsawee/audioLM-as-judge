...
def main():
    ...
    # [x] python exp1_tmhintqi_typhoon2_multiturn.py --data_path data/data_tmhintqi_pairwise_diffall.json --output_path experiments/tmhintqi/ab_testing/diffall_typhoon2_prompt2.txt --order ab --message_format 2
    # [x] python exp1_tmhintqi_typhoon2_multiturn.py --data_path data/data_tmhintqi_pairwise_diffall.json --output_path experiments/tmhintqi/ab_testing/diffall_typhoon2_prompt2_format1.txt --order ab --message_format 1
    # [x] python exp1_tmhintqi_typhoon2_multiturn.py --data_path data/data_tmhintqi_pairwise_diffall.json --output_path experiments/tmhintqi/ab_testing/diffall_typhoon2_prompt2_BA.txt --order ba --message_format 2
    # [x] python exp1_tmhintqi_typhoon2_multiturn.py --data_path data/data_tmhintqi_pairwise_diffall.json --output_path experiments/tmhintqi/ab_testing/diffall_typhoon2_prompt2_format1_BA.txt --order ba --message_format 1
