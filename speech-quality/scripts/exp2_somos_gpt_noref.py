...
def main():
    ...
    # python exp2_somos_pointwise_noref.py --data_path data/data_somos_pointwise450.json --output_path experiments/somos/pointwise/pointwise450_prompt1_noref.jsonl --message_format 1
