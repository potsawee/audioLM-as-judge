...
def main():
    ...
    # TMHINTQI Experiment
    # python exp1_tmhintqi_gemini_multiturn.py --model_name gemini-1.5-flash --data_path data/data_tmhintqi_pairwise_diffall.json --output_path experiments/tmhintqi/ab_testing/shuffled_gemini5flash_prompt2.jsonl --order ab
    # python exp1_tmhintqi_gemini_multiturn.py --model_name gemini-1.5-flash --data_path data/data_tmhintqi_pairwise_diffall.json --output_path experiments/tmhintqi/ab_testing/shuffled_gemini5flash_prompt2_BA.jsonl --order ba
