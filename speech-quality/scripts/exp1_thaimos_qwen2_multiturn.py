...
def main():
    ...
    # python exp1_thaimos_qwen2_multiturn.py --data_path data/data_thaimos_pairwise_diffall.json --output_path experiments/thaimos/ab_testing/shuffled_qwen2_prompt1_BA.txt --order ba --message_format 1
