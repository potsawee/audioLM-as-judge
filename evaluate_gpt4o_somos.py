...
from gpt4o_audio_api import ab_testing, gpt4o_mos, get_encoded_audio_from_path
...
def ab_testing_and_write_results(audio_path, input_csv, output_file, reference_audio_file, ab_testing_fn):
    ...
    with open(output_file, 'w', encoding='utf-8') as tsv:
        ...
        for file in tqdm(file_list, desc="Processing files"):
            ...
            encoded_comparison = get_encoded_audio_from_path(comparison_audio_path)
            ...
            encoded_comparison = get_encoded_audio_from_path(comparison_audio_path)
            encoded_reference = get_encoded_audio_from_path(reference_audio_path)

            # Perform AB testing and get the assessment result
            assessment = ab_testing_fn(encoded_reference, encoded_comparison)
