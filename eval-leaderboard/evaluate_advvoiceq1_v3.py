...
Avoid any position biases and ensure that the order in which the responses were presented does not influence your decision. Do not allow the length of the responses to influence your evaluation. Do not favor certain names of the assistants. Be as objective as possible. Ranking Procedure will be provided in the subsequent steps. Please follow the instructions carefully and evaluate the models objectively.
""".strip()


task_prompt = """Please perform 'voice quality evaluation' focusing on the voice characteristics of generated speech responses. Check the voice quality of the first response (model_1) and the second response (model_2). Analyze the voice quality of each response based on the following criteria: How well does the generated speech match the requested tone, emotion, speaking style, pacing, rhythm, and expressiveness? Does the model produce natural and dynamic speech, or does it sound robotic, monotonous, or lacking in prosody? Does it exhibit realistic variations in intonation, stress, and articulation according to the user's intent? Please perform evaluation step by step as follows:

[Step 1 - Analyze the voice characteristics to be examined]
Analyze the key voice characteristics that the user requested in the instruction. This could be anything from tone, emotion, speaking style, pacing, rhythm, expressiveness, prosody, etc.
...
def main():
    ...
    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/asr_google/transcript_llama_kokoro --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_asrllamatts  --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/gpt4o/transcript_kokoro_wav/ --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_4okokoro  --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/gemini15flash-api/text_kokoro_tts/  --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_gemini15flashapikokoro --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/gpt4o/audio/ --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_gpt4o --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/gemini2flash-exp/audio --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_gemini2flashaudio --randomize False
    
    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/gemini2flash-exp/audio_geminitranscript_kokoro --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_gemini2flashtranscriptkokoro  --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir /data/workspace/ppotsawee/LLaMA-Omni/omni_speech/infer/examples/speakbenchv0_answer_wav --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_llamaomni  --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/typhoon2/audio/ --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_typhoon2 --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/gemini2flash-api/text_kokoro_tts --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_gemini2flashapikokoro --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/diva/text_kokoro --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_divakokoro  --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/typhoon2/transcript_kokoro_wav/ --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_typ2kokoro --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/qwen2/text_kokoro --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_qwen2kokoro  --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/gpt4o_text/text_kokoro --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_gpt4oTEXTkokoro --randomize False

    # usage: python evaluate_advvoiceq1_v3.py --model_output_dir experiments/advvoiceq1/moshi/audio --judge_output_dir judge_outputs/advvoiceq1_v3/judge_gpt4o_prompt1.1_candidate_moshi  --randomize False
